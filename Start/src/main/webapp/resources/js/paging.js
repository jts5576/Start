   ...
   $('table.paginated').each(
         function() {
            ...
            $table.bind('repaginate', function() {
               ...
               // [처음]
               $('<button class="pageNum first"><<</button>').bind(
                     'click',
                     {
                        newPage : page
                     },
               ...
               // [이전]
               $('<button class="pageNum back"><</button>').bind(
                     'click',
                     {
                        newPage : page
                     },
               ...
               for (var page = nowp; page < endp; page++) {
                  $('<span class="pageNum"></span>').text(page + 1).bind(
                        'click',
                        {
                           newPage : page
                        },
               ...
               // [다음]
               $('<button class="pageNum next">></button>').bind(
                     'click',
                     {
                        newPage : page
                     },
               ...
               // [끝]
               $('<button class="pageNum last">>></button>').bind(
                     'click',
                     {
                        newPage : page
                     },
