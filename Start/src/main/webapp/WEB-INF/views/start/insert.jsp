...
// 		alert("글을 성공적으로 작성되었습니다.");
// 	}
	// 상단버튼 이미지로고(Pino&System)
...
//	 	console.log(regno);
		...
		var firstNum = regno.substring(0, 2);	// 주민번호 앞 두자리(87)
...
//	 	console.log(genType);
	...
	$("#InsertForm").click(function(){
		...
		console.log("mil_startdate:" , mil_startdate); // console.log ("mil_startdate:" + mil_startdate) <- 배열아니면상관없음, 배열엔 ,로 지정
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="#" id="clickHome">Pino & System</a>
...
<div class="container-flude">
	<div class="row">
	<form role="form" method="POST" action="/start/insert">
	<div style="float:right; margin-right=20px; magin-bottm: 10px;">
		<input type="submit" class="btn btn-default" id="InsertForm" value="등록"/>
		...
		<div class="col-md-12">
			...
			<input type="button" value="프로필사진 등록" class="btn btn-default" 
			id="btn-profile" data-img="">
			...
			<div class="col-md-3">
				...
				<input type="text" class="form-control"	
						id="sabun" name="sabun" readonly="readonly"/>
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
				<input type="password" class="form-control" id="pwd" name="pwd" maxlength="8"/>
				</div>
			</div>
			<div class="col-md-3">
				...
				<input type="password" class="form-control" id="pwd1" name="pwd1"
						maxlength="9" placeholder="비밀번호와 동일하게 입력해주세요."/>
						<span>
			...
			<div class="col-md-3">
				...
				<input type="text" class="form-control" id="reg_no" maxlength="14"/>
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
				<input type="text" class="form-control" id="years" name="years" maxlength="3"/>
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				<div class="col-md-12">
				<div class="col-md-6">
					<div class="col-md-5"><label>직종체크</label></div>
					<div class="col-md-7">
			...
			<div class="col-md-9">
				...
				<div class="col-md-4">
					...
					<div class="col-md-5">
					<input type="button" class="btn btn-default" value="주소검색" 
						id="addrSearch" name="addrSearch"/>
					</div>
				</div>
				<div class="col-md-4">
				...
				<div class="col-md-4">
					<input type="text" class="col-md-7 form-control" 
						id="addr2" name="addr2" placeholder="세부주소"/>
			...
			<div class="col-md-9">
				...
				<div class="col-md-9">
					<input type="text" class="form-control" id="salary" name="salary" 
						style="float: right;text-align: right;" placeholder="(만원)"/>
				</div>
				</div>
			</div>
			<div class="col-md-12">
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
					<input type="text" class="form-control-sm"
						readonly="readonly"  id="mil_startdate"/>
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
					<input type="text" class="form-control-sm"
						readonly="readonly" id="mil_enddate"/>
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
				<input type="text" class="form-control-sm" id="join_day" readonly="readonly"/>
			...
			<div class="col-md-3">
				...
				<div class="col-md-9">
				<input type="text" class="form-control-sm" id="retire_day" readonly="readonly"/>
			...
			<div class="col-md-3">
				...
				<div class="col-md-9" id="cmp_reg">
					<input type="text" class="form-control" 
					id="cmp_reg_no" name="cmp_reg_no" maxlength="12"/>
				</div>
			</div>
			<div class="col-md-3">
			...
			<div class="col-md-3">
				...
				<div class="col-md-9"><p></p>
					<input type="text" class="form-control" id="cmp_reg_image" readonly="readonly"/>
           			<input type="hidden" name="cmp_reg_image" id="cmp_hidden_image" value=""/>
				</div>
			</div>
			<div class="col-md-3">
			<div class="col-md-6">
				<input type="button" value="미리보기" id="modal-cmp" 
					class="col-md-12 btn btn-default" data-img=""/>
			</div>
			<div class="col-md-6">
				<input type="button" value="사업자등록증 등록" id="btn-upload" class="col-md-12 btn btn-default"/>
			...
			<div class="col-md-12">
				...
				<div class="col-md-10">
					<textarea class="form_control" id="self_info" name="self_info" 
						style="width:100%;text-overflow:ellipsis;" rows=3 
						placeholder="100자 이내로 작성하여주십시오."></textarea>
				</div>
				</div>
				<div class="col-md-3">
				<div class="col-md-3"><label>이력서</label></div>
				<div class="col-md-9">
					<input type="text" class="form-control" id="carrier" readonly="readonly"/>
					<input type="hidden" name="carrier" id="hidden_carrier" value=""/>
				</div>
				</div>
				<div class="col-md-3">
				<div class="col-md-6">
					<input type="button" value="미리보기" id="modal_carrier" 
						class="col-md-12 btn btn-default" data-img=""/>
				</div>
				<div class="col-md-6">
					<input type="button" value="이력서 등록" id="btn-upload-file" class="col-md-12 btn btn-default"/>
